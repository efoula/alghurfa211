...
<section class="mb-10 lg:mb-24">
    ...
    <div class="flex flex-wrap items-center justify-center gap-3 lg:gap-7">
        <a href="<?php echo get_permalink(5) . '?issue=' . $issue_id . '&subject=' . $post_type
        ; ?>" class="px-4 py-2 font-bold text-black shadow-md bg-primary font-cairo lg:text-base text-sm rounded-[10px]"><?php echo $posttype_ar_name; ?></a>
