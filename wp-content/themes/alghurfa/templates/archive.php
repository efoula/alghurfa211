...
<section class="mb-24">
  ...
  <button class="relative text-right archive-filter-button w-full shadow-md text-base font-extrabold px-6 py-3 rounded-[15px] bg-primary md:hidden mb-8">
        ...
        <ul class="pr-8 list-disc">
          ...
          if ($issues) {
            foreach ($issues as $issue) {
              ...
              <li>
                <a class="text-lg font-normal leading-normal transition-all duration-300 ease-in-out md:text-main hover:opacity-50 <?php if ($url_issue_id == $issue_id) {
                                                                                                                                          echo 'selected';
                                                                                                                                        } ?>" id="<?php echo $issue_id; ?>">
                  <?php echo $issue_name; ?>
                </a>
              </li>
        ...
        <ul class="pr-8 list-disc">
          ...
          if ($post_types) {
            foreach ($post_types as $post_type) {
              ...
              ?>
              <li>
                <a id="<?php echo $post_type; ?>" class="text-lg font-normal leading-normal transition-all duration-300 ease-in-out md:text-main hover:opacity-50 <?php if ($url_subject == $post_type) {
                                                                                                                                                                        echo 'selected';
                                                                                                                                                                      } ?>">
        ...
        <ul class="pr-8 list-disc">
          ...
          if ($collaborators) {
            foreach ($collaborators as $collaborator) {
              ...
              <li>
                <a class="text-lg font-normal leading-normal transition-all duration-300 ease-in-out md:text-main hover:opacity-50 <?php if ($url_collaborator == $collaborator_id) {
                                                                                                                                          echo 'selected';
                                                                                                                                        } ?>" data-colid="<?php echo $collaborator_id; ?>">
